...
const line1Blue: StationDef[] = [
  S('b01', 'بنك الأول (ساب)', 'Alawwal Bank (SABB)', 24.8475, 46.6293, 1, true),
  S('b02', 'د. سليمان الحبيب', 'Dr. Sulaiman Al Habib', 24.8197, 46.6366, 2),
  S('b03', 'المركز المالي', 'KAFD', 24.7618, 46.6385, 3, true),
  S('b04', 'المروج', 'Al Muruj', 24.7508, 46.6548, 4),
  S('b05', 'حي الملك فهد', 'King Fahd District', 24.7432, 46.6601, 5),
  S('b06', 'حي الملك فهد 2', 'King Fahd District 2', 24.7365, 46.6632, 6),
  S('b07', 'الاتصالات السعودية', 'STC', 24.7275, 46.6661, 7, true),
  S('b08', 'الورود 2', 'Al Worood 2', 24.73336, 46.67723, 8),
  S('b09', 'العروبة', 'Al Orouba', 24.7121, 46.6744, 9),
  S('b10', 'مصرف الإنماء', 'Alinma Bank', 24.7015, 46.6811, 10),
  S('b11', 'بنك البلاد', 'Bank AlBilad', 24.6932, 46.6892, 11),
  S('b12', 'مكتبة الملك فهد', 'King Fahd Library', 24.6855, 46.6958, 12),
  S('b13', 'وزارة الداخلية', 'Ministry of Interior', 24.6751, 46.7022, 13),
  S('b14', 'المربع', 'Al Murabba', 24.6644, 46.7103, 14),
  S('b15', 'الجوازات', 'Passport Department', 24.6539, 46.7118, 15),
  S('b16', 'المتحف الوطني', 'National Museum', 24.6469, 46.7108, 16, true),
  S('b17', 'البطحاء', 'Al Batha', 24.6378, 46.7121, 17),
  S('b18', 'قصر الحكم', 'Justice Palace', 24.6311, 46.7134, 18, true),
  S('b19', 'العود', 'Al Oud', 24.6184, 46.7215, 19),
  S('b20', 'سكيرينة', 'Sukayrinah', 24.6052, 46.7311, 20),
  S('b21', 'منفوحة', 'Manfuhah', 24.5948, 46.7402, 21),
  S('b22', 'مستشفى الإيمان', 'Iman Hospital', 24.5881, 46.7478, 22),
  S('b23', 'مركز النقل العام', 'Public Transport Center', 24.5815, 46.7533, 23),
  S('b24', 'العزيزية', 'Al Aziziyah', 24.5772, 46.7570, 24),
  S('b25', 'الدار البيضاء', 'Dar Al Bayda', 24.5428, 46.7794, 25),
]
