...
def seed_stations(db: Session, lines: list[Line]) -> list[Station]:
    ...
    stations_data = [
        ...
        {"name_ar": "حيӠناد", "name_en": "Al Janad", "line": red, "order": 12, "lat": 24.6350, "lng": 46.8100, "is_interchange": False},
        ...
        {"name_ar": "طريق абْيَر", "name_en": "Abiyar Road", "line": orange, "order": 17, "lat": 24.7500, "lng": 46.8580, "is_interchange": False},
        ...
        {"name_ar": "حي المnz", "name_en": "Al Manz", "line": purple, "order": 9, "lat": 24.9300, "lng": 46.6300, "is_interchange": False},
